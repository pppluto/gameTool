...
function getResJson(name) {
    ...
    const str = (0, fs_extra_1.readFileSync)((0, path_1.join)(Assets, `${name}.json`), 'utf-8');
    return str ? JSON.parse(str) : null;
}
exports.getResJson = getResJson;
function getResReadme(name) {
    const Assets = (0, path_1.join)(__dirname, '../res/readme');
    return (0, fs_extra_1.readFileSync)((0, path_1.join)(Assets, `${name}.md`), 'utf-8');
}
exports.getResReadme = getResReadme;
function getResMeta(name) {
    const Assets = (0, path_1.join)(__dirname, '../res/meta');
    const str = (0, fs_extra_1.readFileSync)((0, path_1.join)(Assets, `${name}.meta`), 'utf-8');
    return str ? JSON.parse(str) : null;
}
...
async function createFolderByUrl(url, opts) {
    ...
    for (let index = 0; index < pathArr.length; index++) {
        ...
        if (!(0, fs_extra_1.existsSync)(convertUrlToPath(pathHead))) {
    ...
    if (opts === null || opts === void 0 ? void 0 : opts.readme) {
        (0, fs_extra_1.writeFileSync)((0, path_1.join)(convertUrlToPath(url), `.${(0, path_1.basename)(url)}.md`), opts.readme);
    }
    // 创建子目录
    if (opts === null || opts === void 0 ? void 0 : opts.subPaths) {
        ...
        for (let index = 0; index < opts.subPaths.length; index++) {
            ...
            if (!(0, fs_extra_1.existsSync)(convertUrlToPath(subPath))) {
    ...
    if (opts === null || opts === void 0 ? void 0 : opts.subFolders) {
        ...
        for (let index = 0; index < opts.subFolders.length; index++) {
            ...
            // 判断是否存在
            if (!(0, fs_extra_1.existsSync)(convertUrlToPath(subUrl))) {
            ...
            // readme
            if (subOpts.readme) {
                (0, fs_extra_1.writeFileSync)((0, path_1.join)(convertUrlToPath(subUrl), `.${(0, path_1.basename)(subUrl)}.md`), subOpts.readme);
            }
        }
    }
    return true;
